...
client.on("message", message => {
	...
	const rating = Math.floor(Math.random() * 100) + 1;
		...
		.addField(null,"[Bạn có thể xem Event Shop tại đây.](https://tinyurl.com/5anzuzed)")
		.addField(null,"[Bạn có thể xem Event Profile tại đây.](https://tinyurl.com/5csaahua)")
